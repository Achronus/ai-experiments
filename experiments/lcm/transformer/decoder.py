...
from experiments.lcm.linear import FeedForwardNetwork, GLUFeedForwardNetwork
...
class DecoderOnlyLayerConfig:
    ...
    Args:
        ...
        use_swiglu (bool, optional): a flag for using GLU Feed-Forward networks instead of regular ones. When `True` ignores `weight_init_fn` and `activation`. Default is False
    """
